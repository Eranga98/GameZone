                        ...
                        <td class="column-description desc">
                            <div>
                                <form action="">
                                    ...
                                    <div style="margin-bottom: 10px; float: left; margin-left: 0; margin-right: 10px;"><input class="button-primary mwp-wpvivid-login-btn" id="mwp_wpvivid_active_btn" type="button" value="Login"/></div>
