    ...
    public function output_edit_schedule($global)
    {
        if($global){
            ...
            <script>
                ...
                function mwp_get_wpvivid_global_sync_time(option_name,current_day_hour,current_day_minute) {
                    var hour='00';
                    var minute='00';
                ...
                function mwp_wpvivid_click_create_incremental_schedule(){
                    ...
                    var db_current_day=mwp_get_wpvivid_global_sync_time('mwp_incremental_backup','db_current_day_hour','db_current_day_minute');
                    var files_current_day=mwp_get_wpvivid_global_sync_time('mwp_incremental_backup','files_current_day_hour','files_current_day_minute');
                    var current_day = {
