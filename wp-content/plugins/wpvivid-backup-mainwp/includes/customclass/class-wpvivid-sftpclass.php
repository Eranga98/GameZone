...
class Mainwp_WPvivid_SFTPClass extends Mainwp_WPvivid_Remote
{
    ...
    public function mwp_wpvivid_add_storage_page_sftp_addon(){
        ?>
        <div class="storage-account-page-addon" id="mwp_wpvivid_storage_account_sftp_addon" style="display:none;">
            <div class="mwp-wpvivid-block-bottom-space"><strong>Enter Your SFTP Account</strong></div>
            <table class="wp-list-table widefat plugins" style="width:100%;">
                <tbody>
                <tr>
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="sftp-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="sftp-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
        ...
        <div class="mwp-wpvivid-remote-storage-edit" id="mwp_wpvivid_storage_account_sftp_edit" style="display: none;">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="edit-sftp-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="edit-sftp-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
