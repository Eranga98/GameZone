        ...
        <div class="storage-account-page-addon" id="mwp_wpvivid_storage_account_ftp_addon">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="ftp-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="ftp-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input class="ui green mini button" type="button" option="add-remote-addon-global" value="Save and Sync">
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
        ...
        <div class="mwp-wpvivid-remote-storage-edit" id="mwp_wpvivid_storage_account_ftp_edit" style="display: none;">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="edit-ftp-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="edit-ftp-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
