...
class Mainwp_Wpvivid_S3Compat extends Mainwp_WPvivid_Remote{
    ...
    public function mwp_wpvivid_add_storage_page_s3compat_addon(){
        ?>
        <div class="storage-account-page-addon" id="mwp_wpvivid_storage_account_s3compat_addon" style="display: none;">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="s3compat-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="s3compat-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input class="ui green mini button" option="add-remote-addon-global" type="button" value="Save and Sync" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
        ...
        <div class="mwp-wpvivid-remote-storage-edit" id="mwp_wpvivid_storage_account_s3compat_edit" style="display: none;">
            ...
            <table class="wp-list-table widefat plugins" style="width:100%;">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-retain" autocomplete="off" option="edit-s3compat-addon" name="backup_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
                ...
                <tr>
                    <td class="plugin-title column-primary">
                        <div class="mwp-wpvivid-storage-form">
                            <input type="text" class="regular-text mwp-wpvivid-remote-backup-db-retain" autocomplete="off" option="edit-s3compat-addon" name="backup_db_retain" value="30" />
                        </div>
                    </td>
                    <td class="column-description desc">
                        <div class="mwp-wpvivid-storage-form-desc">
